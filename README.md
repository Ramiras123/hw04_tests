...
Яндекс Практикум. Спринт 5. Итоговый проект. Покрытие тестами проекта Yatube v2: [hw03_forms](https://github.com/Ramiras123/hw03_forms):
...
1. Клонировать репозиторий:
   ...
   ```python
   git clone https://github.com/Ramiras123/hw04_tests.git
   ```
